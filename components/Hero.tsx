      ...
      <div className="relative z-10 min-h-[100svh] md:min-h-[70vh] flex items-center justify-center">
        ...
        >
          ...
          >
            <Link
              href="#how-it-works"
              className="w-full sm:w-80 px-8 py-3.5 bg-forest-600 text-white font-semibold rounded-md hover:bg-forest-700 transition-colors text-center whitespace-nowrap"
            >
              SEE HOW IT WORKS
            </Link>
            <Link
              href="#contact"
              className="w-full sm:w-80 px-8 py-3.5 bg-white/10 backdrop-blur-sm border-2 border-white text-white font-semibold rounded-md hover:bg-white/20 transition-colors text-center whitespace-nowrap"
            >
