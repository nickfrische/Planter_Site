      ...
      <div className="relative z-10 min-h-[90vh] flex items-end">
        <div className="container-padding max-w-[1400px] mx-auto w-full pb-40 pt-20">
          ...
          >
            ...
            >
              <span className="text-white font-medium text-sm">Smart Watering Solutions</span>
            </motion.div>
            ...
            >
              Professional irrigation setup and maintenance for container plants. Automated watering systems that keep your planters thriving.
            </motion.p>
